...
public class CLRWithDP extends LinAdapt {
	...
	protected double[] m_abNuA = new double[]{0, 0.2}; // N(0,1) for shifting
	...
	protected void sampleThetaStars(){
		for(int m=m_kBar; m<m_kBar+m_M; m++){
			if (m_thetaStars[m] == null) {
				if (this instanceof CLinAdaptWithDP || this instanceof MTCLinAdaptWithDP)
					m_thetaStars[m] = new _thetaStar(m_dim*2);
				else
...
//		setPersonalizedModel();
	...
	public void setMultiThreading(boolean b){
		m_multiThread = b;
	}
}
