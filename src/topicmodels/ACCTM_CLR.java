...
public class ACCTM_CLR extends ACCTM_C{
	public ACCTM_CLR(int number_of_iteration, double converge, double beta, _Corpus c, double lambda,
	...
	public String toString(){
		return String.format("ACCTM_CLR topic model [k:%d, alpha:%.2f, beta:%.2f, Logistic regression Gibbs Sampling]", 
