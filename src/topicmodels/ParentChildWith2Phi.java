...
//	 
//	  public ParentChildWith2Phi(int number_of_iteration, double converge,
//	  double beta, _Corpus c, double lambda, int number_of_topics,
//	  double alpha, double burnIn, int lag, double[] gammaParent,
//	  double[] gammaChild, double mu) {
//	  super(number_of_iteration, converge, beta, c, lambda,
//	 number_of_topics,
//	  alpha, burnIn, lag, gammaParent, mu);
...
//	 
//	  System.arraycopy(gammaParent, 0, m_gammaParent, 0,
//	 m_gammaParent.length);
...
//	  m_gammaParent.length);
//	  ((_ParentDoc4ThreePhi) d).createLocalWordTopicDistribution(
//	  this.vocabulary_size, d_beta);
//	  for (_Stn stnObj : d.getSentences())
//	  stnObj.setTopicsVct4ThreePhi(number_of_topics,
//	  m_gammaParent.length);
//	  } else if (d instanceof _ChildDoc) {
//	  ((_ChildDoc4ThreePhi) d).createXSpace(number_of_topics,
//	  m_gammaChild.length);
//	  ((_ChildDoc4ThreePhi) d).createLocalWordTopicDistribution(
//	  this.vocabulary_size, d_beta);
...
//	  } else if (xid == 1) {
//	  // update pair
//	  _ParentDoc4ThreePhi pDoc = (_ParentDoc4ThreePhi) ((_ChildDoc4ThreePhi)
//	  d).m_parentDoc;
...
//	  double mu = Utils.cosine_values(tempParent.getSparse(),
//	 d.getSparse());
//	  d.setMu(mu);
//	  }
//	 
...
//	  protected double localParentWordByTopicProb(int wid,
//	 _ParentDoc4ThreePhi
//	  d) {
...
//	  }
//	 
//	  protected double parentChildInfluenceProb(int tid, _ParentDoc4ThreePhi
//	 d)
//	  {
//	  double term = 1.0;
//	 
...
//	  }
//	 
//	  protected double childTopicInDocProb(int tid, _ChildDoc4ThreePhi cDoc,
//	  _ParentDoc4ThreePhi pDoc) {
//	  double docLength = pDoc.m_globalWord;
//	 
//	  return (d_alpha + cDoc.getMu() * pDoc.m_sstat[tid] / docLength +
//	  cDoc.m_sstat[tid])
...
//	  childDoc.createLocalWordTopicDistribution(this.vocabulary_size,
//	  d_beta);
...
//	  double corpusLogLikelihood = 0;// how could we get the corpus-level
//	  // likelihood?
//	 
...
//	  double wordPerTopicLikelihood = parentWordByTopicProb(k, index)
//	  * parentTopicInDocProb(k, d)
//	  / (d.m_globalWord + number_of_topics * d_alpha)
//	  * parentXInDocProb(0, d)
//	  / (d.getTotalDocLength() + gammaLen);
//	  wordLogLikelihood += wordPerTopicLikelihood;
//	 
//	  }
//	 
//	  wordLogLikelihood += localParentWordByTopicProb(index, d)
//	  * parentXInDocProb(1, d)
//	  / (d.getTotalDocLength() + gammaLen);
//	 
...
//	  * childTopicInDocProb(k, d,
//	  (_ParentDoc4ThreePhi) d.m_parentDoc)
//	  * childXInDocProb(0, d)
//	  / (d.getTotalDocLength() + gammaLen);
//	  wordLogLikelihood += wordPerTopicLikelihood;
//	  }
...
//	  double gammaLen = Utils.sumOfArray(m_gammaParent);
//	  if (xid == 0) {
//	  return (m_gammaParent[xid] + pDoc.m_globalWord)
//	  / (gammaLen + pDoc.getTotalDocLength())
//	  + stnObj.m_xSstat[xid];
//	  } else if (xid == 1) {
//	  return (m_gammaParent[xid] + pDoc.m_parentWord)
//	  / (gammaLen + pDoc.getTotalDocLength())
//	  + stnObj.m_xSstat[xid];
//	  }
//	  return 0;
//	  }
//	 
//	  public double parentTopicInStnProb(int tid, _Stn stnObj,
//	  _ParentDoc4ThreePhi d) {
//	  return (d_alpha + d.m_topics[tid] + stnObj.m_topicSstat[tid])
//	  / (m_kAlpha + 1 - d.m_topics[number_of_topics] + stnObj.m_xSstat[0]);
//	  }
//	 
...
//	  + d.m_topics[k];
//	  }
//	  stnObj.m_topics[number_of_topics] +=
//	  stnObj.m_topicSstat[number_of_topics];
//	  }
//	 
//	  public void debugOutput(String filePrefix) {
//	 
//	  File parentTopicFolder = new File(filePrefix +
//	 "parentTopicAssignment");
...
//	  System.out.println("creating pair directory"
//	  + parentPairTopicDistriFolder);
...
//	  printPairWordTopicDistribution((_ParentDoc4ThreePhi) d,
//	  parentPairTopicDistriFolder);
//	  } else if (d instanceof _ChildDoc) {
//	  printTopicAssignment(d, childTopicFolder);
//	  printChildXValue(d, childXFolder);
//	  printChildLocalWordTopicDistribution((_ChildDoc4ThreePhi) d,
...
//	  }
//	 
//	  public void printPairWordTopicDistribution(_ParentDoc4ThreePhi d,
//	  File parentPairTopicDistriFolder) {
//	  String parentLocalTopicDistriFile = d.getName() + ".txt";
//	  try {
//	  PrintWriter parentOut = new PrintWriter(new File(
//	  parentPairTopicDistriFolder, parentLocalTopicDistriFile));
//	 
...
//	  }
//	 
//	  public void printChildLocalWordTopicDistribution(_ChildDoc4ThreePhi d,
...
//	  }
//	 
//	  protected HashMap<Integer, Double> rankStn4ChildBySim(_ParentDoc pd,
//	  _ChildDoc cd) {
//	 
...
//	  }
//	 
//	  protected HashMap<String, Double> rankChild4StnByLikelihood(_Stn
//	 stnObj,
//	  _ParentDoc d) {
//	 
//	  _ParentDoc4ThreePhi pDoc = (_ParentDoc4ThreePhi) d;
//	  HashMap<String, Double> childLikelihoodMap = new HashMap<String,
//	  Double>();
//	  double gammaLen = Utils.sumOfArray(m_gammaChild);
//	 
//	  for (_ChildDoc cDoc : pDoc.m_childDocs) {
...
//	  }
//	 
//	  protected double rankChild4ParentByLikelihood(_ParentDoc4ThreePhi pd,
//	  _ChildDoc cd) {
//	  _ParentDoc4ThreePhi pDoc = (_ParentDoc4ThreePhi) pd;
//	  _ChildDoc4ThreePhi cDoc = (_ChildDoc4ThreePhi) cd;
//	  int cDocLen = cDoc.getTotalDocLength();
...
//	  }
//	 
//	  void discoverSpecificComments(MatchPair matchType, String
//	 similarityFile)
//	  {
...
//	  stnTopicSimilarity = computeSimilarity(
//	  stnObj.m_topics, cDoc.m_xTopics[0]);
//	  else if (matchType == MatchPair.MP_ChildLocal)
//	  stnTopicSimilarity = computeSimilarity(
//	  stnObj.m_topics, cDoc.m_xTopics[1]);
//	 
