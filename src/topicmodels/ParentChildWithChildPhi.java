...
//
//	public ParentChildWithChildPhi(int number_of_iteration, double converge,
//			double beta, _Corpus c, double lambda, int number_of_topics,
//			double alpha, double burnIn, int lag, double[] gammaChild, double mu) {
//		super(number_of_iteration, converge, beta, c, lambda, number_of_topics,
//				alpha, burnIn, lag, gammaChild, mu);
...
//				((_ChildDoc4ChildPhi) d).createXSpace(number_of_topics,
//						m_gammaChild.length);
//				((_ChildDoc4ChildPhi) d).createLocalWordTopicDistribution(
...
//	}
//
//	protected double childTopicInDocProb(int tid, _ChildDoc4ChildPhi cDoc,
//			_ParentDoc pDoc) {
...
//						/ (docLen + number_of_topics * d_alpha);
...
//						* childTopicInDocProb(k, d, pDoc)
//						* childXInDocProb(0, d)
//						/ (d.getTotalDocLength() + gammaLen);
//				wordLogLikelihood += wordPerTopicLikelihood;
//			}
//
//			wordLogLikelihood += childLocalWordByTopicProb(wid, d)
//					* childXInDocProb(1, d)
//					/ (d.getTotalDocLength() + gammaLen);
//
//			if (Math.abs(wordLogLikelihood) < 1e-10) {
...
//				printChildLocalWordTopicDistribution((_ChildDoc4ChildPhi) d,
...
//	}
//
//	public void printChildLocalWordTopicDistribution(_ChildDoc4ChildPhi d,
...
//				for (int k = 0; k < number_of_topics; k++) {
//					double wordPerTopicLikelihood = childWordByTopicProb(k, wid)
//							* childTopicInDocProb(k, cDoc, cDoc.m_parentDoc)
//							* childXInDocProb(0, cDoc)
//							/ (cDoc.getTotalDocLength() + gammaLen);
//					wordLogLikelihood += wordPerTopicLikelihood;
//				}
//				wordLogLikelihood += childLocalWordByTopicProb(wid, cDoc)
...
//			for (int k = 0; k < number_of_topics; k++) {
//				double wordPerTopicLikelihood = childWordByTopicProb(k, wid)
//						* childTopicInDocProb(k, (_ChildDoc4ChildPhi) cDoc,
//								pDoc)
//						* childXInDocProb(0, (_ChildDoc4ChildPhi) cDoc)
//						/ (cDoc.getTotalDocLength() + gammaLen);
//				wordLogLikelihood += wordPerTopicLikelihood;
//			}
//
//			wordLogLikelihood += childLocalWordByTopicProb(wid,
//					(_ChildDoc4ChildPhi) cDoc)
//					* childXInDocProb(1, (_ChildDoc4ChildPhi) cDoc)
//					/ (cDoc.getTotalDocLength() + gammaLen);
//
