...
public class testParentChild_Debug {
	public static void main(String[] args) throws IOException, ParseException {
		...
		String topicmodel = "LDA_GibbsDebug"; // LDA_GibbsDebug
...
//		LocalTime today = LocalTime.now();
		...
		ParentChildAnalzyerDebug analyzer = new ParentChildAnalzyerDebug(tokenModel,
		...
		if (topicmodel.equals("2topic")) {
			...
			if (topicmodel.equals("pLSA")) {
				...
				// varConverge);
			}  else if (topicmodel.equals("LDA_GibbsDebug")) {
				// in gibbs sampling, no need to compute log-likelihood during
				// sampling
				model = new LDA_GibbsDebug(gibbs_iteration, 0,
