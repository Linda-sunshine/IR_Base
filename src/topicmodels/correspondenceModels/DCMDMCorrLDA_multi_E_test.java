...
public class DCMDMCorrLDA_multi_E_test extends DCMDMCorrLDA_multi_E{
	public DCMDMCorrLDA_multi_E_test(int number_of_iteration, double converge, double beta,
