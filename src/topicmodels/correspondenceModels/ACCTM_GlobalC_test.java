 ...
 */
public class ACCTM_GlobalC_test extends ACCTM_GlobalC {
    public ACCTM_GlobalC_test(int number_of_iteration, double converge, double beta, _Corpus c, double lambda,
                ...
                if(i==number_of_topics){
                    ...
                    for (int j = 0; j < vocabulary_size; j++)
                        fVector.add(new _RankItem(m_corpus.getFeature(j),
                                m_rareWordTopicProb[j]));

                    betaOut.format("Topic %d(%.3f):\t", i, 0.0);
