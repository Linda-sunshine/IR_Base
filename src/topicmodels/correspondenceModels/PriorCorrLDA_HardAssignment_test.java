 ...
 */
public class PriorCorrLDA_HardAssignment_test extends PriorCorrLDA_HardAssignment {
    public PriorCorrLDA_HardAssignment_test(int number_of_iteration, double converge,
                                            double beta, _Corpus c, double lambda, int number_of_topics,
                                            double alpha, double alpha_c, double burnIn, int lag, double ksi, double tau){
