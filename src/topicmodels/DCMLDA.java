	...
	protected void initialize_probability(Collection<_Doc> collection) {
		...
		for (_Doc d : collection) {
			...
			for (int k = 0; k < number_of_topics; k++){
				...
				a += topicProb;
				if (k == 0)
					t_alphaInit += topicProb * topicProb;
				m_sstat[k] += topicProb;
