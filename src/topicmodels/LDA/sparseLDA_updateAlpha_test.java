 ...
 */
public class sparseLDA_updateAlpha_test extends sparseLDA_updateAlpha {
    public sparseLDA_updateAlpha_test(int number_of_iteration, double converge, double beta, _Corpus c, double lambda,
                          int number_of_topics, double alpha, double burnIn, int lag, double tParam, double sParam, int newtonIter, double newtonConverge) {
        super(number_of_iteration, converge, beta, c, lambda, number_of_topics, alpha, burnIn, lag, tParam, sParam, newtonIter, newtonConverge);
    }
