...
//					System.out.println(cDoc.getName() + "\t");
	...
	public static void main(String[] args) throws IOException, ParseException {
		...
		int minimunNumberofSentence = 2; // each document should have at least 2
											// sentences

		/***** parameters for the two-topic topic model *****/
		String topicmodel = "wsdm"; // 2topic, pLSA, HTMM, LRHTMM,
													// Tensor, LDA_Gibbs,
		...
		String fvFile = String.format(
				...
				articleType);
		// String fvFile =
		// String.format("./data/Features/fv_%dgram_topicmodel.txt", Ngram);
		...
		String infoFilePath = "./data/results/Topics_" + number_of_topics
				+ "_Information.txt";
		// //store top k words distribution over topic
		String topWordPath = "./data/results/beta_" + number_of_topics + "_"
				+ topicmodel + "_" + ".txt";

		Calendar today = Calendar.getInstance();
		String filePrefix = String.format("./data/results/%s-%s-%s%s-%s",
		...
		// endProb, DFthreshold); //Select the features.
		...
		_Corpus c = analyzer.returnCorpus(fvStatFile); // Get the collection of
														// all the documents.
