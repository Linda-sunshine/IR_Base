...
//	public int m_ttlUserSetNo = 10; // The total number of user sets.
	...
	private void exit_with_help()
	{
		System.out.print(
				...
				+"options:\n"
				+"-nuI : list of controlled vocabular to be used in feature generation (default null)\n"
				+"-sdA : statistics of the features collected from the corpus (default null)\n"
				+"-sdB : vector representation file (default null)\n"
				+"-eta1 : classifier's debug output file (default null)\n"
				+"-eta2 : classifier's debug output file (default null)\n"
				+"-eta3 : classifier's debug output file (default null)\n"
				+"-eta4 : classifier's debug output file (default null)\n"
				+"-model : classifier's debug output file (default null)\n"
				+"-fv : classifier's debug output file (default null)\n"
				+"-fvSup : classifier's debug output file (default null)\n"
				+"-M : classifier's debug output file (default null)\n"
				+"-data : classifier's debug output file (default null)\n"
