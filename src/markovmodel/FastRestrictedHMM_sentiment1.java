...
public class FastRestrictedHMM_sentiment1 extends FastRestrictedHMM {

	double m_sigma;//probability of sentiment switch
	double m_transitMatrix[][];
	
	public FastRestrictedHMM_sentiment1(double epsilon,double sigma, int maxSeqSize, int topicSize) {
