...
//        analyzer.saveCVIndex4Network(cvIndexFile4NonInteraction, false);
        ...
        String cvIndexFile4Rec = String.format("%s/%s/%sCVIndex4Recommendation.txt", prefix, dataset, dataset);
...
//            analyzer.loadInteractions(friendFile);
//        }
//        String coldPrefix = String.format("./data/DataEUB/ColdStart4Edges/%s_cold_start_4edges_fold_%d_noninteractions_time_2", dataset, k);
//        analyzer.loadTestUsers(coldPrefix);
//        analyzer.printTestInteractions(String.format("./data/DataEUB/ColdStart4Edges/%s_cold_start_4edges_fold_%d_interactions", dataset, k));
    }
