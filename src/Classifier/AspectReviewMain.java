...
public class AspectReviewMain {
	...
	public static void main(String[] args) throws IOException, ParseException{
		...
		AspectAnalyzer analyzer = new AspectAnalyzer(tokenModel, stnModel, classNumber, "", Ngram, lengthThreshold, aspectModel, 50);
		...
		boolean aspAnnotate = false; //if this value is true, then do the bootstrapping, else skip this step.
