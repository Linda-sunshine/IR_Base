...
public class CFExecution {
	public static void main(String[] args) throws InvalidFormatException, FileNotFoundException, IOException{
		...
		String dataset = param.m_data; // "Amazon", "Yelp"
...
//		String filename = String.format("./data/%s_cf_time_%d_tok%d.txt", dataset, param.m_t, param.m_k);
		String filename = String.format("/if15/lg5bt/DataWWW2017/%s/%s_cf_time_%d_topK_%d.txt", dataset, dataset, param.m_t, param.m_k);
