...
//		CLinAdaptWithHDP hdp = new CLinAdaptWithHDP(classNumber, analyzer.getFeatureSize(), globalModel, null, globalLM);
		...
		MTCLinAdaptWithHDP hdp = new MTCLinAdaptWithHDP(classNumber, analyzer.getFeatureSize(), globalModel, null, null, globalLM);
		hdp.setR2TradeOffs(eta3, eta4);
		hdp.setsdB(0.1);

		hdp.setsdA(0.1);
		double alpha = 0.1, eta = 0.2, beta = 0.01;
